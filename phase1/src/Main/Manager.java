...
public class Manager {
    ...
    public void LoginCheckError(Matcher matcher){
        ...
        profileController = new profileController(FindUserByUserName(matcher.group(1)));
    }
    ...
    public boolean CheckIfPasswordIsValid(String Password){
        ...
        public void ForgetPasswordAndChangePasswordProcess(Matcher matcher) {
            ...
            if (CheckIfTheUserHasLoggedIn(matcher.group(1))) {
                ...
                while (!(input = MyConsole.nextLine()).equals(FindUserByUserName(matcher.group(1)).getPasswordRecoveryQuestionNumber())) {
    ...
    public void showInformation(){
        ...
        if (CheckIfTheUserHasLoggedIn(user.getUsername())){
    ...
    public void changePassword(String newPassword, String oldPassword){
        if (CheckIfTheUserHasLoggedIn(profileController.getUser().getUsername())){
            if (CheckIfPasswordIsOkay(profileController.getUser().getUsername(), oldPassword)){
                if (CheckIfPasswordIsValid(newPassword)){
                    if (!newPassword.equals(oldPassword)){
                        profileController.setPassword(newPassword);
                        System.out.println("Your new newPassword is set");
                    }else {
    ...
    public void changeUsername(String username){
        if (CheckIfTheUserHasLoggedIn(profileController.getUser().getUsername())){
            if (!CheckIfUsernameExist(username)){
                ...
                System.out.println("Your new username is set");
            }else {
                System.out.println("Your username is used");
            }
        }else {
            System.out.println("You are not logged in");
        }
    ...
    public void changeNickname(String nickname){
        if (CheckIfTheUserHasLoggedIn(profileController.getUser().getUsername())){
            if (!CheckIfNicknameExist(nickname)){
                profileController.setNickName(nickname);
                System.out.println("Your new nickname is set");
            }else {
                System.out.println("Your nickname is used");
            }
        }else {
            System.out.println("You are not logged in");
        }
    ...
    public void changeEmail(String email){
        if (CheckIfTheUserHasLoggedIn(profileController.getUser().getUsername())){
            if (!CheckIfEmailExist(email)){
                ...
                System.out.println("Your email is used");
            }
        }else {
            System.out.println("You are not logged in");
        }
